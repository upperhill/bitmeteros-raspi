...
$(function(){
 ...
 // Handlers for the 2 Save... buttons on the Colours tab 
    ...
    $('#prefsColoursRemote').click(function(){
        setColoursOnModel();
        $('#prefsSaveColoursStatus').html('Saving colour choices to the server... <img src="js/bitmeter/css/images/working.gif" /> ');
 ...
 // Handler for the Save... button on the RSS tab   
    $('#prefsRssSave').button().click(function(){
        ...
        if (!rssNumItems){
            ...
            $('#prefsRssSaveStatus').html('Saving RSS parameters... <img src="js/bitmeter/css/images/working.gif" />');
            jQuery.ajax({
 ...
 // Handler for the Save... button on the Server Name tab       
    $('#prefsServerNameSave').button().click(function(){
        $('#prefsServerNameSaveStatus').html('Saving Server Name... <img src="js/bitmeter/css/images/working.gif" />');
        jQuery.ajax({
 ...
 // Handler for the 2 Save... buttons on the Refresh Intervals tab          
    ...
    $('#prefsRefreshSaveRemote').click(function(){
        if (setIntervalsOnModelOk()){
            ...
            $('#prefsRefreshSaveStatus').html('Saving Refresh Intervals... <img src="js/bitmeter/css/images/working.gif" />');
            jQuery.ajax({
                url : url, 
                success : function(){
