...
$(function(){
    var queryResultsGridObj, dateFormat, queryDialog, datePickerOpts = { showOn: 'button', buttonImage: 'js/bitmeter/css/images/calendar.gif' };
     ...
     // We do some validation on the date values entered by the user, empty fields don't cause an error
        ...
        if (errList.length === 0){
         // The date values were ok, so continue
            $('#queryStatusBox').html('Searching... <img src="js/bitmeter/css/images/working.gif" alt="search in progress" />');
